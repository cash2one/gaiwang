<?php $this->breadcrumbs = array(Yii::t('business', '商业区') => array('admin'), Yii::t('business', '列表')); ?>
<?php
...
<?php if (Yii::app()->user->checkAccess('Travel.Business.Create')): ?>
    <a class="regm-sub"  href="<?php echo Yii::app()->createAbsoluteUrl('travel/business/create') ?>"><?php echo '添加商业区' ?></a>
<?php endif; ?>
    <div class="c10"></div>
<?php
