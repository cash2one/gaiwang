 ...
 * @var BusinessController $this
 * @var Business $model
 */
$this->breadcrumbs = array(
    Yii::t('business', '商业区') => array('admin'),
    $model->isNewRecord ? Yii::t('business', '新增') : Yii::t('business', '修改')
);
?>
<?php
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tab-come">
        ...
        <tr>
            <td colspan="2" class="title-th even"
                align="center"><?php echo $model->isNewRecord ? Yii::t('city', '添加商业区') : Yii::t('city', '修改商业区'); ?></td>
        </tr>
        </tbody>
        <tbody>
            ...
            <td class="odd">
                ...
                echo $form->dropDownList($model, 'nation_id', CHtml::listData(Nation::model()->findAll(), 'id', 'name'), array(
                    ...
                    'ajax' => array(
                        ...
                        'success' => 'function(data) {
                            $("#Business_province_code").html(data.dropDownProvinces);
                        }'
                    )
                ));
                ?>
                ...
                echo $form->dropDownList($model, 'province_code', isset($province)?$province:array(), array(
                    ...
                    'ajax' => array(
                        ...
                        'success' => 'function(data) {
                            $("#Business_city_code").html(data.dropDownCities);
                        }'
                    )
                ));
                ?>
