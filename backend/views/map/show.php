    ...
    <body>
        <div class="main">
            <div class="head-title">
                ...
                <div class="t-com ws">
                    <div class="t-sub"><input type="button" value="<?php echo Yii::t('map', '取消'); ?>" class="reg-sub" id="btnCancel" onclick="btnCancelClick()" /></div>
                    <div class="breadcrumbs"><?php echo Yii::t('map', '选取坐标'); ?></div>
                </div>
                <div class="t-right"></div>
            </div>
            <div class="com-box">
                <div class="border-info clearfix">
                    <?php echo Yii::t('map', '地址搜索'); ?>：<input type="text" id="txtAddr" class="text-input-bj  least" />
                    <input type="button" value="搜索" onclick="searchAddr()" class="reg-sub" />
                    <?php echo Yii::t('map', '当前城市'); ?>：<input type="text" id="txtCurrentCity" class="text-input-bj  least" disabled="disabled" />
                    <input type="button" value="<?php echo Yii::t('map', '修改'); ?>" onclick="changeCity()" class="reg-sub" />
                    ...
                    <input type="button" value="<?php echo Yii::t('map', '选取坐标'); ?>" onclick="markClick()" class="regm-sub" />
                </div>
