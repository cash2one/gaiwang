...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('life_topic_id')); ?>:</b>
	<?php echo CHtml::encode($data->life_topic_id); ?>
	<br />
	...
	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('passed_time')); ?>:</b>
	<?php echo CHtml::encode($data->passed_time); ?>
	<br />
