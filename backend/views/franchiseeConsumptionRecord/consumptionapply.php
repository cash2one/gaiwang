...
?>
<?php
$this->renderPartial('_searchconsumptionapply', array(
    'model' => $model,
));
?>
<div id="franchisee-consumption-record-grid">
    <table width="100%" border="0" cellspacing="0" cellpadding="0"
        ...
        <tr class="tab-reg-title">
            ...
            <th><?php echo Yii::t('franchiseeConsumptionRecord', '状态'); ?></th>
...
$form = $this->beginWidget('CActiveForm', array(
    'action' => Yii::app()->createUrl('franchiseeConsumptionRecord/consumptionPass'),
    'method' => 'post',
...
<?php
$form = $this->beginWidget('CActiveForm', array(
    'action' => Yii::app()->createUrl('franchiseeConsumptionRecord/consumptionFail'),
    'method' => 'post',
...
<?php
$form = $this->beginWidget('CActiveForm', array(
    'action' => Yii::app()->createUrl('franchiseeConsumptionRecord/consumptionAuditing'),
    'method' => 'post',
