<div class="border-info clearfix">
                ...
                <td>
                    ...
                    echo $form->dropDownList($model, 'franchisee_province_id', Region::getRegionByParentId(Region::PROVINCE_PARENT_ID), array(
                        ...
                        'ajax' => array(
                            ...
                            'success' => 'function(data) {
	                            $("#FranchiseeConsumptionRecordConfirm_franchisee_city_id").html(data.dropDownCities);
	                        }',
                    )));
                    ?>
                    ...
                    echo $form->dropDownList($model, 'franchisee_city_id', Region::getRegionByParentId($model->franchisee_province_id), array(
                        ...
                        'ajax' => array(
                            ...
                            'update' => '#FranchiseeConsumptionRecordConfirm_franchisee_district_id',
                            'data' => array(
    ...
    <table cellpadding="0" cellspacing="0" class="searchTable">
        <thead>
            <tr>
                ...
                <td id="tdDistStatus">
                    <?php echo $form->radioButtonList($model, 'status', FranchiseeConsumptionRecordConfirm::getApplyStatus(), array('separator' => '')) ?>
                </td>
            </tr>
        </thead>
    </table>
    ...
    <?php if (Yii::app()->user->checkAccess('FranchiseeConsumptionRecord.ConsumptionPass')): ?>
        <?php echo CHtml::Button(Yii::t('franchiseeConsumptionRecord', '通过'), array('class' => 'regm-sub', 'id' => 'pass')); ?>
    <?php endif; ?>
    <?php if (Yii::app()->user->checkAccess('FranchiseeConsumptionRecord.ConsumptionAuditing')): ?>
        <?php echo CHtml::Button(Yii::t('franchiseeConsumptionRecord', '审核'), array('class' => 'regm-sub', 'id' => 'auditing')); ?>
    <?php endif; ?>
    <?php if (Yii::app()->user->checkAccess('FranchiseeConsumptionRecord.ConsumptionFail')): ?>
