...
$this->widget('GridView', array(
    'id' => 'enterprise-grid',
    'dataProvider' => $model->searchFinish(),
    'itemsCssClass' => 'tab-reg',
    'cssFile' => false,
    'columns' => array(
        array(
            'name' => Yii::t('enterprise', '审核时间'),
        ...
        array(
            ...
            'buttons' => array(
                'view' => array(
                    ...
                    'visible' => '$data->el_status==' . EnterpriseLog::STATUS_PASS . " AND Yii::app()->user->checkAccess('Enterprise.View')",
                    'options' => array(
                        'class' => 'regm-sub-a',
                    )
                ),
