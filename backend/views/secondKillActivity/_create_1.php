...
?>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab-come">
    ...
    <tr>
        ...
        <td>
            <?php echo $form->textField($model, 'gift', array('class' => 'text-input-bj  middle', 'value'=>'', 'placeholder'=>'请填写0.01-100之间的数', 'onkeyup'=>"this.value=dealPoint(this.value);")); ?><span>%  请填写0.01-100之间的数</span>
