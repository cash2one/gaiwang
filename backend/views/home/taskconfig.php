 ...
 $(document).ready(
    ...
    <table width="100%" border="0" class="tab-come" cellspacing="0" cellpadding="0">
        <tbody>
            <tr>
                <th>
                    <?php echo $form->labelEx($model,'cbkMem');?>：
                </th>
                <td>
                    <?php echo $form->checkBox($model,'cbkMem',array('class' => 'show-checkbox'))?>
                </td>
            </tr>
            <tr>
                <th>
                    <?php echo $form->labelEx($model,'cbkSMS');?>：
                </th>
                <td>
                    <?php echo $form->checkBox($model,'cbkSMS',array('class' => 'show-checkbox'))?>
                </td>
            </tr>
        </tbody>
    </table>
