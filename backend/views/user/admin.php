...
<?php if ($this->getUser()->checkAccess('User.Create')): ?>
...
$this->widget('GridView', array(
    ...
    'columns' => array(
        ...
        array(
            ...
            'buttons' => array(
                'update' => array(
                    'visible' => '$data->username != "admin" && Yii::app()->user->checkAccess("User.Update")'
                ),
                'delete' => array(
                    'visible' => '$data->username != "admin" && Yii::app()->user->checkAccess("User.Delete")'
                ),
                'reset' => array(
                    'label' => Yii::t('user', '重置密码'),
                    'visible' => "Yii::app()->user->checkAccess('User.Reset')",
