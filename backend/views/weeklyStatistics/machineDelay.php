...
<div class="main">
    <div class="line tjbox">
        <div class="line title_one">
            ...
            <div class="unit title_onezi">盖机最新运行时间数据</div>
        </div>

        <?php if (Yii::app()->user->checkAccess('WeeklyStatistics.MachineDelayExport')):?>
            <?php $form=$this->beginWidget('CActiveForm', array(
                'action'=>Yii::app()->createUrl('WeeklyStatistics/MachineDelayExport'),
                'method'=>'post',
            )); ?>
