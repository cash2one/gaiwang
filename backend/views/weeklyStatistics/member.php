<div class="main">
    <div class="line tjbox">
        <div class="line title_one">
            ...
            <div class="unit title_onezi">会员数据</div>
        </div>

        <?php if (Yii::app()->user->checkAccess('WeeklyStatistics.MemberExport')):?>
            <?php $form=$this->beginWidget('CActiveForm', array(
                'action'=>Yii::app()->createUrl('WeeklyStatistics/MemberExport'),
                'method'=>'post',
            ));
            ?>
