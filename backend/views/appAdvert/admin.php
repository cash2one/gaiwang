...
<?php if (Yii::app()->user->checkAccess('AppAdvert.Create')): ?>
...
$this->widget('GridView', array(
    ...
    'columns' => array(
        ...
        array(
            ...
            'value' => 'CHtml::link( $data->pictureCount, array("/appAdvertPicture/admin","advert_id"=>"$data->id") ,array("class"=>"reg-sub" ))'
        ),
        array(
            'class' => 'CButtonColumn',
            ...
            'buttons' => array(
                'update' => array(
                    'label' => Yii::t('user', '编辑'),
                    'visible' => "Yii::app()->user->checkAccess('AppAdvert.Update')"
                ),
                'delete' => array(
                    'label' => Yii::t('user', '删除'),
                    'visible' => "Yii::app()->user->checkAccess('AppAdvert.Delete')"
                ),
            )
        )
    ),
