...
<div class="border-info clearfix search-form">
    ...
    <table cellpadding="0" cellspacing="0" class="searchTable">
        <tbody>
            <tr>
              <?php if($this->getAction()->getId()=='admin'):?>
                <th><?php echo $form->label($model, 'gai_number'); ?></th>
                <td><?php echo $form->textField($model, 'gai_number', array('class' => 'text-input-bj  least')); ?></td>
                <th><?php echo $form->label($model, 'card_no'); ?></th>
                <td><?php echo $form->textField($model, 'card_no', array('class' => 'text-input-bj  least')); ?></td>
                ...
                <td><?php
                    echo $form->dropDownList($model, 'month', AccountFlow::getMonth(), array(
                        ...
                        'ajax' => array(
                            'type' => 'POST',
                            'url' => $this->createUrl('/accountFlowHistory/changeMonth'),
                            'data' => array(
                                'month' => 'js:this.value',
