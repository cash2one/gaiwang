...
<div class="line tjbox">
    <div class="line title_one">
        ...
        <div class="unit title_onezi">商家-消费者排名</div>
    </div>
    
    <?php if (Yii::app()->user->checkAccess('Statistics.StoreCustomerRankExport')):?>
    <div class="t-sub">
         <a href="<?php echo Yii::app()->createUrl('statistics/storeCustomerRankExport',array('store_id'=>$_REQUEST['store_id'],'time'=>isset($_GET['time'])?$_GET['time']:''));?>" target="_blank" class="regm-sub">导出excel</a>
    </div>
    <br/><br/>
    <?php endif;?>
        ...
        <div class="line tjbox2">
            <div class="line title_two">
                ...
                <div class="unit title_twozi">
                   商家（<?php echo $storeInfo->store_name; ?>）下的消费者消费金额排名</div>
            </div>
            <div class="line tjbox_nr">
