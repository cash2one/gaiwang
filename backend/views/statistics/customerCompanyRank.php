...
<div class="line tjbox">
    <div class="line title_one">
        ...
        <div class="unit title_onezi">消费者-商家排名</div>
    </div>
    
    <?php if (Yii::app()->user->checkAccess('Statistics.CustomerStoreRankExport')):?>
    <div class="t-sub">
         <a href="<?php echo Yii::app()->createUrl('statistics/customerStoreRankExport',array('member_id'=>$_REQUEST['member_id'],'time'=>isset($_GET['time'])?$_GET['time']:''));?>" target="_blank" class="regm-sub">导出excel</a>
    </div>
    <br/><br/>
    <?php endif;?>
        ...
        <div class="line tjbox2">
            <div class="line title_two">
                ...
                <div class="unit title_twozi">
                    消费者（<?php echo $enterprise->member_name; ?>）下的商家销售金额排名</div>
            </div>
            <div class="line tjbox_nr">
