...
<div class="line tjbox">
    ...
    <div class="t-sub">
         <a href="<?php echo Yii::app()->createUrl('statistics/rankExport',array('type'=>4,'findId'=>$_REQUEST['member_id']));?>" target="_blank" class="regm-sub">导出excel</a>
    </div>
    <br/><br/>
    <?php endif;?>
        ...
        <div class="line tjbox2">
            <div class="line title_two">
                ...
                <div class="unit title_twozi">
                    消费者（<?php echo $memberName; ?>）下的商家销售金额排名</div>
            </div>
