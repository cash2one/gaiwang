...
<div class="line tjbox">
    ...
    <div class="t-sub">
         <a href="<?php echo Yii::app()->createUrl('statistics/rankExport',array('type'=>2,'findId'=>$_REQUEST['store_id']));?>" target="_blank" class="regm-sub">导出excel</a>
    </div>
    <br/><br/>
    <?php endif;?>
        ...
        <div class="line tjbox2">
            <div class="line title_two">
                ...
                <div class="unit title_twozi">
                   商家（<?php echo $storeName; ?>）下的消费者消费金额排名</div>
            </div>
            <div class="line tjbox_nr">
