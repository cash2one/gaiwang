 <script type="text/javascript">
    ...
    <script type="text/javascript">
        var search = function () {
            ...
            var myUrl = "<?php echo urldecode(Yii::app()->createUrl('statistics/customerRank', array('time' => '"+selectedTime+"'))); ?>"
            location.href = myUrl;
        };
    </script>
    <script type="text/javascript">
...
<div class="line tjbox">
    ...
    <?php if (Yii::app()->user->checkAccess('Statistics.CustomerRankExport')):?>
    <div class="t-sub">
         <a href="<?php echo Yii::app()->createUrl('statistics/customerRankExport',array('time'=>isset($_GET['time'])?$_GET['time']:''));?>" target="_blank" class="regm-sub">导出excel</a>
    </div>
    <br/><br/>
    <?php endif;?>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($dataRes as $v):?>
                            <tr>
                                ...
                                <td>
                                    <?php echo CHtml::link('商家销售占比排行',Yii::app()->createUrl('statistics/customerStoreRank',array('member_id'=>$v['member_id'],'time'=>isset($_GET['time'])?$_GET['time']:'')),array("target"=>"_blank"));?>
                                </td>
                            </tr>
                            <?php $i++;?>
                            <?php endforeach;?>
