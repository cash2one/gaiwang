            ...
            <ul>
                ...
                <li>
                    <span class="party-name">推广地区</span>
                            ...
                            <?php $ids = implode('     ',$ids) ;?>
                            <?php echo Region::getAreaNameById(Region::getAreaIdByProvinceId($contract_model->p_province_id)).$ids; ?>
                            </span>
                </li>
                <li>
                ...
                <li>
                    <span class="party-name"><i class="red">*</i>营业执照注册地区</span>
                            ...
                            <?php $ids = Region::getNameArray($ids); ?>
                            <?php $ids = implode('     ',$ids) ;?>
                            <?php echo Region::getAreaNameById(Region::getAreaIdByProvinceId($contract_model->province_id)).$ids; ?>
                            </span>
                </li>
                <li>
