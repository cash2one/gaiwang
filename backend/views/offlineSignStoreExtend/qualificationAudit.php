...
$this->breadcrumbs = array(
    ...
    Yii::t('offlineSignStore', '审核资质(非运作部)'),
...
<?php if($extendModel->apply_type == OfflineSignStoreExtend::APPLY_TYPE_NEW_FRANCHIESE) :?>
    <?php $this->renderPartial('_qualificationNew',array('extendModel'=>$extendModel,'enterprise_model'=>$enterpriseModel,'contract_model'=>$contractModel,'storeData'=>$storeData))?>



<?php elseif($extendModel->apply_type == OfflineSignStoreExtend::APPLY_TYPE_OLD_FRANCHIESE):?>
    <?php $this->renderPartial('_qualificationOld',array('extendModel'=>$extendModel,'enterprise_model'=>$enterpriseModel,'storeData'=>$storeData))?>
<?php endif;?>
