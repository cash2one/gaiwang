        ...
        <div class="main">
            <div class="head-title">
                ...
                <div class="t-com ws" style="width: 1629px;">
                    <div class="t-sub">
                     <?php
                        $acts = array('member','memberLog','create', 'update', 'view','edit','enterpriseUpdate','enterpriseCreate','updateRecommend','updateImportant','specValueAdmin','updateImgs','addHongBaoAmount','updateEndTime', 'creditView', 'update2','viewPay','viewStore','viewPartner','viewUnder','viewMonthr','saveregion','createregion','memberApplyCashDetail','detail','SupplementTransactions');
                        ...
                        if (in_array($action, $acts) || (isset($this->showBack) && $this->showBack == true)){
                           if($this->id=="machine"){
                              echo CHtml::link(Yii::t('main', '返回列表'), "/?r=machine/admin", array('class' => 'regm-sub'));
                               	...
                               	if($action == "saveregion" || $action == "createregion"){
                               		echo CHtml::link(Yii::t('main', '返回列表'), "/?r=regionManage/index", array('class' => 'regm-sub'));
                                }elseif($action == "memberApplyCashDetail"){
                                    echo CHtml::link(Yii::t('main', '返回列表'), "/?r=cashHistory/memberapplycash", array('class' => 'regm-sub'));
                                }elseif($action == 'SupplementTransactions'){
                                    echo CHtml::link(Yii::t('main', '返回列表'), "/?r=accountPosRecord/admin", array('class' => 'regm-sub'));
                                }else{
