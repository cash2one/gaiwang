...
<div class="border-info clearfix">
    ...
    <table cellspacing="0" cellpadding="0" class="searchTable">
        <tbody><tr>
            <th>
                <?php echo Yii::t('cashHistory','盖网通编号'); ?>：
            </th>
            <td>
    ...
    <table cellspacing="0" cellpadding="0" class="searchTable">
        <tbody><tr>
            ...
            <td>
                ...
                <?php echo $form->dropDownList($model,'role',$model::memberCashType()) ?>
            </td>
        </tr>
        </tbody>
    </table>
   ...
   <?php if($this->getAction()->getId() == 'enterpriseApplyCash'):?> 
    <table cellspacing="0" cellpadding="0" class="searchTable">
        <tbody><tr>
            <th>
                <?php echo Yii::t('cashHistory','金额选择'); ?>：
            </th>
            <td>
                <?php echo $form->dropDownList($model,'moneyType',$model::MoneyShow(),array('class'=>'text-input-bj  middle')) ?>
            </td>  
        </tr>
        </tbody>
    </table>
    ...
    <table cellspacing="0" cellpadding="0" class="searchTable">
        <tbody><tr>
            <th>
                <?php echo Yii::t('cashHistory','白名单'); ?>：
            </th>
            <td>
                <textArea row='5' cols='80' readonly><?php echo Tool::getConfig('cashhistory','whiteList')?></textArea>
            </td>  
        </tr>
        </tbody>
    </table>
