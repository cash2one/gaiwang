...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab-come">
    ...
    <tr>
        <th width="100" align="right">
            <?php echo Yii::t('cashHistory','会员号'); ?>：
        </th>
        <td>
           <?php echo $memberModel->gai_number ?>
        </td>
    </tr>
    <tr>
        <th width="100" align="right">
    ...
    <tr>
        <td colspan="2" style="text-align: center" class=" title-th">
            <?php echo Yii::t('cashHistory','会员申请兑现信息'); ?>
        </td>
    </tr>
    <tr>
        <th width="100" align="right">
            <?php echo Yii::t('cashHistory','兑现金额'); ?>：
        </th>
        <td>
    ...
    <tr>
        <th width="100" align="right">
            <?php echo Yii::t('cashHistory','会员申请时的兑现比率'); ?>：
        </th>
        <td>
            <?php echo $model->ratio ?>
        </td>
    </tr>
    <tr>
        <th width="100" align="right">
        ...
        <td>
            <?php echo sprintf('%0.2f',$model->factorage*$model->money/100/$model->ratio); ?>
            <?php echo Yii::t('cashHistory','积分'); ?>
        </td>
    </tr>
    <tr>
        <th width="100" align="right">
            <?php echo Yii::t('cashHistory','会员申请时的手续率'); ?>：
        </th>
        <td>
    ...
    <tr>
        <th width="100" align="right">
            <?php echo Yii::t('cashHistory','实际扣除积分'); ?>：
        </th>
        <td>
            <?php echo $model->score ?><?php echo Yii::t('cashHistory','积分'); ?>
        </td>
    </tr>
    <tr>
        <th width="100" align="right">
