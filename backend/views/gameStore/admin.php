...
<?php if (Yii::app()->user->checkAccess('GameStore.Create')): ?>
...
$this->widget('GridView', array(
    ...
    'columns' => array(
        ...
        array(
            'name' => 'franchise_stores',
            'value' => 'GameStore::franchiseStores($data->franchise_stores)'
        ),
        array(
            'name' => 'create_time',
        ...
        array(
            ...
            'buttons' => array(
                'update' => array(
                    ...
                    'visible' => "Yii::app()->user->checkAccess('GameStore.Update')"
                ),
                'items' => array(
                    'label' => Yii::t('gameStore', '商品'),
                    'imageUrl' => false,
                    'url' => 'Yii::app()->createUrl("/gameStoreItems/admin",array("storeId" => $data->id))',
                    'visible' => "Yii::app()->user->checkAccess('GameStoreItems.Admin')"
                ),
            )
        ),
    ),
