...
//兽人来了游戏配置 视图
/**
 * @author: xiankuan.huang
 * @mail: xiankuan.huang@g-emall.com
 * Date: 2016/8/15
 * Time: 10:36
...
<?php $form = $this->beginWidget('CActiveForm', $formConfig); ?>
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tab-come">
        ...
        <tr>
            ...
            <td>
                <?php echo $form->hiddenField($model, 'app_type',array('value' => AppVersion::APP_TYPE_GAME_SHOURENLAILE)); ?>
