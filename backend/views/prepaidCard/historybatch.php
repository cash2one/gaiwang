<?php $this->breadcrumbs = array('充值兑换管理', '批发充值卡记录');?>
<div style="width:65%">
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" class="integralTab mgtop10">
    ...
    <tr>
        ...
        <th width="142" height="40" align="center" class="tdBg">申请时间</th>
    ...
    <?php if(!empty($data)):?>
        <?php foreach ($data as $k => $v): ?>
            <tr>
                ...
                <td height="35" align="center" valign="middle" class="bgF4">
                    <?php echo CHtml::form(Yii::app()->createAbsoluteUrl('PrepaidCard/HistoryDownLoad',array('num'=>$v['batch_number']))) ?>
