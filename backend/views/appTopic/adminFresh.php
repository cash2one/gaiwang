...
$this->breadcrumbs = array(Yii::t('AppTopic', '主题') => array('admin'), Yii::t('AppTopic', '盖鲜汇'));
...
<?php if (Yii::app()->user->checkAccess('AppTopic.Create')): ?>
    <a class="regm-sub" href="<?php echo $this->createAbsoluteUrl('/AppTopic/create/id/3') ?>"><?php echo Yii::t('AppTopic', '添加主题专题') ?></a>
<?php endif; ?>
<div class="c10"></div>
<?php
$this->widget('GridView', array(
    'id' => 'AppTopic-grid',
    'dataProvider' => $model->search(AppTopic::FRESH_COLLECTION),
    'cssFile' => false,
