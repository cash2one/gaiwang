        ...
        <tr>
           <th><?php echo $form->label($model, 'title'); ?>：</th>
            <td><?php echo $form->textField($model, 'title', array('class' => 'text-input-bj  least')); ?></td>
             <th><?php echo $form->label($model, 'min_title'); ?>：</th>
            <td><?php echo $form->textField($model, 'min_title', array('class' => 'text-input-bj  least')); ?></td>
            <th><?php echo $form->label($model, 'status'); ?>：</th>
            <td><?php echo $form->dropDownList($model, 'status', AppHotCategory::getPublish(), array('prompt' => '全部')); ?></td>
