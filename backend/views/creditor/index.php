...
<script type="text/javascript">
    ...
    function delCheck(obj) {
        ...
        var myUrl = "<?php echo MANAGE_DOMAIN ?>/?r=creditor/delete&id=" + id;
        art.dialog({
            icon: 'question',
            content: '确认删除？',
            lock: true,
...
<?php if ($this->getUser()->checkAccess('Business.Create')): ?>
    <input id="Btn_Add" type="button" value="<?php echo Yii::t('user', '添加'); ?>" class="regm-sub" onclick="location.href = '<?php echo Yii::app()->createAbsoluteUrl("/creditor/create"); ?>'">
<?php endif; ?>
<div class="c10"></div>
<?php
...
//    'ajaxUpdate' => false,
    'columns' => array(
        array(
            ...
            'name' => 'creditor_tran',
            'value' => '$data->creditor_tran'
        ),
        array(
            'class' => 'CButtonColumn',
            'header' => '操作',
            'template' => '{previewIndex}{previewStore}{previewDel}{export}',
