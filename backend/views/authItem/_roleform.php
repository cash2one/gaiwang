...
<table width="100%" border="1" cellspacing="1" cellpadding="0" id="tbRoles">
    <tbody>
        ...
        <?php $this->renderPartial('_statistic', array('rights' => $rights)); ?>
        <?php $this->renderPartial('_hotel', array('rights' => $rights)); ?>
        <?php $this->renderPartial('_app', array('rights' => $rights)); ?>
        <?php $this->renderPartial('_trade', array('rights' => $rights)); ?>
        <?php $this->renderPartial('_groupbuy', array('rights' => $rights)) ?>
        <?php $this->renderPartial('_service', array('rights' => $rights)) ?>
        <?php $this->renderPartial('_sideagreement', array('rights' => $rights)) ?>
        <?php $this->renderPartial('_appmanage', array('rights' => $rights)) ?>
