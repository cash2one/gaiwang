...
?>
<?php if (Yii::app()->user->checkAccess('AuthItem.createRole')): ?>
    ...
    'columns' => array(
        ...
        array(
            ...
            'buttons' => array(
                'update' => array(
                    'label' => Yii::t('user', '编辑'),
                    'visible' => 'Yii::app()->user->checkAccess("AuthItem.UpdateRole") && $data->name !== "Admin"',
                    'url' => 'Yii::app()->createUrl("/authItem/updateRole", array("name"=>$data->name))'
                ),
                'delete' => array(
                    'label' => Yii::t('user', '删除'),
                    'visible' => 'Yii::app()->user->checkAccess("AuthItem.Delete") && $data->name !== "Admin"',
