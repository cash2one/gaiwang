<tr>
    ...
    <td>
        ...
        <input type="checkbox" name="rights[]" <?php if (in_array('User.Create', $rights)): ?>checked="checked"<?php endif; ?> value="User.Create" id="UserCreate">
        ...
        <input type="checkbox" name="rights[]" <?php if (in_array('User.Delete', $rights)): ?>checked="checked"<?php endif; ?> value="User.Delete" id="UserDelete">
        ...
        <label for="UserLog">列表</label>
         ...
         <label>权限查询</label>
        (
        <input type="checkbox" name="rights[]" <?php if (in_array('User.QueryAuth', $rights)): ?>checked="checked"<?php endif; ?> value="User.QueryAuth" id="UserQueryAuth">
        <label for="UserQueryAuth">权限查询</label>
        )
    </td>
</tr>