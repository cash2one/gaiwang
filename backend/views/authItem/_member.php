...
<tr>
    ...
    <td>
        ...
        <input type="checkbox" name="rights[]" <?php if (in_array('CommonAccount.AdminExport', $rights)): ?>checked="checked"<?php endif; ?> value="CommonAccount.AdminExport" id="CommonAccountAdminExport">
        <label for="CommonAccountAdminExport">导出excel</label>
        )
    </td>
</tr>
<tr>
...
<tr>
    <td>
        <input type="checkbox" name="rights[]" <?php if (in_array('Sub.MiddleAgent', $rights)): ?>checked="checked"<?php endif; ?> value="Sub.MiddleAgent" id="SubMiddleAgent"><label for="SubMiddleAgent">居间商管理</label>
    </td>
    <td>
        <?php $this->renderPartial('_middle', array('rights' => $rights)); ?>
    </td>
</tr>