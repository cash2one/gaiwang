...
class AccountFlowController extends Controller {
    ...
    public function allowedActions() {
        return 'admin, view, changeMonth,getCountBeforeExportCsv,getCountBeforeExportBatchCsv';
    }
...
//        $str = $this->tree($file_dir);
    ...
    public function actionExportBalance(){
        ...
        if($this->isPost() && $_POST['date']){
            ...
            $sql = "SELECT gai_number,today_amount,`type`,`date` FROM `gw_account_check_{$month}` WHERE `date`='{$date}' ORDER BY id ASC";
