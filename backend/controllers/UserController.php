        ...
        if ($this->isAjax()) {
            ...
            if ($model->mobile != '') {
                ...
                if ($model->save()) {
                    ...
                    $datas = array($model->username, $password);
                    $tmpId = $this->getConfig('smsmodel','machineRestPassId');
                    SmsLog::addSmsLog($model->mobile,$content, $model->id,SmsLog::TYPE_OTHER,null,true, $datas, $tmpId);
                    echo 1;
                }
            }
        }
