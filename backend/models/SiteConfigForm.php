...
//    public $redDeadTime;//红包过期时间

    public function rules() {
        return array(
            array('domain, name, automaticallySignTimeOrders, extendMaximumNum, ordersActivistTime,duration', 'required'),
            array('domain, weibo', 'url'),
//            array('redDeadTime','numerical'),
            array('phone, qq, description, copyright, icp, iconScript, statisticsScript, notice, duration,service_time,category_depth', 'safe')
        );
    }
