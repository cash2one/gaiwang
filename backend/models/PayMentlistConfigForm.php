...
class PayMentlistConfigForm extends CFormModel{
  ...
  public static function isRecommend(){
    ...
    public function rules() {
        return array(
            array('tl_is_open,um_is_open,union_is_open, wx_is_open,ali_is_open,tl_is_recommended ,um_is_recommended,union_is_recommended,wx_is_recommended,ali_is_recommended ','required'),
