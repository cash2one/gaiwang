    ...
    <div class="shopping-pay">
        <div class="order-submit">
            ...
            <div class="pay-type balance-pay">
                    <?php
                        echo $form->checkBox($model, 'jfPay', array('value' => 'JFPay', 'uncheckValue' => null, 'id' => 'selJF', 'checked' => '','class'=>'checkbox'));
//                        echo $form->radioButton($model,'payType',array('uncheckValue'=>null,'value'=>'JF'));
                    ?>
            ...
            <?php  $countlist = 0;?>
             <?php if($sourceType != Order::SOURCE_TYPE_SINGLE):?>
                ...
                <!--网银开始-->
                    <?php echo $this->renderPartial('_bankpay',array('model'=>$model,'form'=>$form,'hasquick'=>$countlist,'soureType'=>$sourceType))?>
                <!-- 网银结束 -->
            </div>
            <?php if($sourceType != Order::SOURCE_TYPE_SINGLE):?>
            ...
            <div id="pay-password" class="pay-password">
                ...
                <?php echo $form->passwordField($model, 'password3', array('class' => 'input-box','value'=>'')) ?>
