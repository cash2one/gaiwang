 <!--添加收货地址-->
          ...
          <div class="address-pop">
              ...
              <div class="address-pop-bg">
                  <p class="pop-title"><?php echo Yii::t('memberAddress', '新增收货地址'); ?></p>
                  <div class="pop-conter">
                  <ul>
                      <li>
                          <?php CHtml::$beforeRequiredLabel="<span class='red'>*</span>";CHtml::$afterRequiredLabel="";?>
                          <div class="pop-left"><?php echo $form->labelEx($model, 'real_name',array('class'=>'required')); ?>：</div>
                      ...
                      <li><div class="pop-left"><?php echo $form->labelEx($model, 'province_id'); ?>：</div>
                          <?php
                      ...
                      <li>
                          <div class="pop-left"><?php echo $form->label($model, 'zip_code'); ?>：</div>
