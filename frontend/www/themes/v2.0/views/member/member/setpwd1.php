        ...
        <?php elseif($step === 2):?>
            ...
            <div class="revise-box">
                <p>
                    ...
                    <?php echo $form->passwordField($model,'password',array('class'=>'input-password','value'=>'','maxlength'=>20));?>
        ...
        <?php elseif($step === 3):?>
            <div class="revise-box bind-success">
                ...
                <p class="revise-result-btn">
                    <input type="button" class="btn-deter btn-deter2" value="马上登录" onclick="window.location.href='<?php echo $this->createAbsoluteUrl("/member/home/login")?>'" />
                </p>
