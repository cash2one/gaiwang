      ...
      <div class="accounts-box">
          ...
          <div class="person-box">
              <div class="person-logo">
                  ...
                  <div class="right">
                      <p class="logo-img"><?php if ($model->head_portrait): ?>
                        ...
                        <?php else: ?>
                            <?php echo CHtml::image( Yii::app()->theme->baseUrl. '/images/bgs/default-avatar.png', '头像', array('width' => 88, 'height' => 88)); ?>
                        <?php endif; ?></p>
             ...
             ?>
              ...
              <div class="person-editor">
                <div class="info-box">
                    <ul>
                    <li class="clearfix">
                        <div class="info-left"><?php echo $model->getAttributeLabel('username') ?>：</div>
                    ...
                    <li class="clearfix">
                        <div class="info-left"><?php echo $model->getAttributeLabel('gai_number') ?>：</div>
                        <?php echo $model->gai_number ?>
                    </li>
                    <li class="clearfix">
                        <div class="info-left"><?php echo $model->getAttributeLabel('real_name') ?>：</div>
			<?php if (empty($model->real_name)): ?>
                    ...
                    <li class="clearfix">
                        <div class="info-left"><?php echo $form->labelEx($model, 'sex'); ?>：</div>
                        <?php if (empty($model->sex)): ?>
			<?php echo $form->radioButtonList($model, 'sex', $model::gender(), array('separator' => '','template'=>'<span class="btn-select">{label}{input}</span>')) ?>
                        <?php echo $form->error($model, 'sex') ?>
                    <?php else: ?>
                        <?php echo $model::gender($model->sex) ?>
                    <?php endif; ?>
                    </li>
                    <li class="clearfix"><div class="info-left"><?php echo $form->labelEx($model, 'birthday') ?>：</div>
                        <?php
			...
			<?php echo $form->error($model, 'birthday') ?>
                    ...
                    <li class="clearfix">
                        <div class="info-left"><?php echo $form->labelEx($model, 'email') ?>：</div>
			...
			<?php echo $form->error($model, 'district_id'); ?>
                ...
                <div class="info-btn">
                    <?php echo CHtml::submitButton(Yii::t('memberMember', '保存'), array('class' => 'btn-deter bankBtn mgtop15')) ?>
                    <input name="" type="button" value="取消" onclick="hidePerson();" class="btn-delete mgtop15" />
                </div>
            </div>
            <?php $this->endWidget(); ?>     
          </div>
...
<script type="text/javascript">
	...
	function hidePerson(){
	    $('.person-editor').css('display', 'none');
