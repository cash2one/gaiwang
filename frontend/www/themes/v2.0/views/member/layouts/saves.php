...
//            }
            ...
            if (totalTime <= 0) {
                ...
                $(btnId).val("<?php echo Yii::t('memberHome', '重新发送'); ?>");
...
//                //alert('<?php echo Yii::t('memberMember', '请等待……'); ?>');
//                $(this).after('<span class="revise-message" id="Member_mobile_vcode_em_" style=""><?php echo Yii::t('memberMember', '请等待……'); ?></span>');
//                return false;
//            }
            setTimeout(function () {
