    ...
    <div class="main-contain">
                ...
                <div class="hc-contain clearfix">
                    ...
                    <div class="impression">
                        <ul id="impress-tag" class="clearfix">
                            <?php echo $form->radioButtonList($model,'impress_id',Comment::getImpress(array(1,2,3,4,5,6,7,8)), array('class'=>'gs-brandBut','uncheckValue'=>null,'separator'=>'', 'container' =>'','template'=>'<li class="good-tag">{label}{input}</li>','labelOptions'=>array('other'=>'impress-zero','style'=>'width:100%;display:inline-block')));?>
        ...
        <div class="order-evaluate">
            ...
            <!--评论产品列表-->
            <?php $this->renderPartial('_goodsedit',array('orderModel'=>$orderModel,'model'=>$model,'form'=>$form,'comment'=>$comment))?>
            <div class="evaluate-submit">
                <?php echo CHtml::checkBox('Comment[is_anonymity]','',array('class'=>'checkbox'))?><span class="checkbox-label"><?php echo Yii::t('membercoment','匿名')?></span>
    ...
    <script>
        ...
        $(function () {
            ...
            $(".des-star").raty({
                ...
                score: <?php echo empty($storeComment) ? 5 : $storeComment->description_match;?>,
                target: ".des-hint",
            ...
            $(".attitude-star").raty({
                ...
                score: <?php echo empty($storeComment) ? 5 : $storeComment->serivice_attitude;?>,
            ...
            $(".speed-star").raty({
                ...
                score: <?php echo empty($storeComment) ? 5 : $storeComment->speed_of_delivery;?>,
                target: ".speed-hint",
