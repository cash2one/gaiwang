    <ul class="product-evaluate">
        ...
        <li>
            ...
            <div class="product-info clearfix">
                <?php echo 
                    CHtml::link(
                      CHtml::image(IMG_DOMAIN . '/' .$g['goods_picture'],$g['goods_name'],array('class'=>'product-img')),
                      $this->createUrl('/goods/view',array('id'=>$g['goods_id']),array('title'=>$g['goods_name']))
                    );
            ...
            <div class="pe-content">
                ...
                <div class="p-eval-items clearfix">
                ...
                <div class="p-eval-items clearfix">
                    ...
                    <?php echo $form->textArea($model,"[$k]content",array('placeholder'=>'商品您是否满意，有什么要和其他用户分享的呢？','class'=>'text-area','maxlength'=>200))?>
                ...
                <div class="p-eval-items clearfix">
                    ...
                    <div class="upload-area">
                        ...
                        <div class="tip-area">
                            <span class="img-num"><?php echo Yii::t('membercomment','0/4图片')?></span>
