...
<div class="steps">
    <ul class="clearfix">
        ...
        <li class="step-item active"><?php echo Yii::t('memberOrder', '评价'); ?></li>
    </ul>
</div>
<div class="deal-time clearfix">
    ...
    <span class="last"><?php echo $this->format()->formatDatetime($model->comment_time); ?></span>
</div>
<div class="step-description">
    <i class="member-icon angle angle-05"></i>
    <div class="order-status">
        <span class="title"><?php echo Yii::t('memberOrder', '订单状态'); ?></span>
        <span class="status-des"><?php echo Yii::t('memberOrder', '交易成功'); ?></span>
    </div>
    <div class="operation">
        <b class="order-tip"><?php echo date('Y-m-d H:i:s', $model->comment_time); ?> <?php echo Yii::t('memberOrder', '订单已评价'); ?></b>
    </div>
