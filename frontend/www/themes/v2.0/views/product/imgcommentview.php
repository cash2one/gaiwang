...
<li class="clearfix">
    ...
    <div class="pdTab2-comInfo3">
        ...
        <span class="pdTab2-zanIco"></span><?php echo Yii::t('goods', '赞'); ?>(<span class="vote_num vote_<?php echo $data['id'];?>" rel="<?php echo $data['id'].'|'.$data['goods_id'];?>"><?php echo $data['vote'];?></span>)
    </div>
