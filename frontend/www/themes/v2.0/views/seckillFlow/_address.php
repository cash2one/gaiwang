...
<div class="orders-address-box">
        ...
        <ul>
            <li class="on"  id="addressLi_<?php echo $Add['id'] ?>">
                ...
                <label for="<?php echo 'address_' . $Add['id'] ?>">
                    <span class="select icon-cart" ><?php echo $Add['real_name'] ?></span>
                </label>
                ...
                <?php echo CHtml::link('删除','javascript:;',array('class'=>'deleted','data-url'=>$Add['id'])); ?>
    ...
    <div class="orders-address-more" style="display: none;">
        <div class="picScroll-top">
            ...
            <div class="bd orders-address-only">
                <div class="tempWrap" style="overflow:hidden; position:relative; height:188px">
                    <ul style="top: 0px; position: relative; padding: 0px; margin: 0px;" class="picList">
                        ...
                        <li style="height: 32px;" class="<?php echo $select_address['id'] == $v['id'] ? 'on':'' ?>" id="addressLi_<?php echo $v['id'] ?>">
                            ...
                            <label for="<?php echo 'address_' . $v['id'] ?>">
                                <span class="select icon-cart" ><?php echo $v['real_name'] ?></span>
                            </label>
    ...
    <p class="address-box">
        <a class="address-up icon-cart" href="#" style="display: none;">收起地址</a>
        <?php if(count($address)>1): ?>
        <a class="address-more icon-cart" href="#" style="display: block;">更多地址</a>
        <?php endif; ?>
    </p>
    <?php endif; ?>
