...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div style="padding: 25px 10px;">
            <?php echo Yii::t('sellerOrder', '会员进行退货，经与会员协商同意，退回订单款项，退款给买家 {b} 元，订单关闭。',array('{a}'=>$returnInfo['freight'],'{b}'=>$returnInfo['backMoney']['pay_price'])); ?>
            <div style="width:500px; text-align: center; margin-top: 10px;"> 
                <input type="button" value="<?php echo Yii::t('sellerOrder', '同意'); ?>" class="button_red1" onclick="RePurcharse('agree', '<?php echo $returnInfo['orderId']; ?>')"/>
                <input type="button" value="<?php echo Yii::t('sellerOrder', '不同意'); ?>" class="button_red1" onclick="RePurcharse('disagree', '<?php echo $returnInfo['orderId']; ?>')"/>
            </div>
        </div>
    </body>
</html>
