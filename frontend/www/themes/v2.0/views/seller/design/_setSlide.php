...
<div class="arbox">
    ...
    <div class="con">
        <table class="table_ar" width="100%" cellspacing="0" cellpadding="0" border="0">
            ...
            <tbody id="dataBody">
            <?php if (isset($design->tmpData[DesignFormat::TMP_MAIN_SLIDE]['Imgs'])): ?>
                <?php foreach ($design->tmpData[DesignFormat::TMP_MAIN_SLIDE]['Imgs'] as $v): ?>
    ...
    <div class="msg msg-info" style="width: 320px; float: left"> <?php echo Yii::t('sellerDesign','图片不能超过6张，请上传 "1903x540" 大小的图片。'); ?></div>
    <div class="editor">
