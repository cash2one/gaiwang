...
<body>
    <div class="main">
        ...
        <div class="head-title">
            ...
            <div class="t-com ws">
                <div class="t-sub">
                    <input type="button" value="取消" class="reg-sub" id="btnCancel" onclick="btnCancelClick()" />
                </div>
                <span class="ico_where">地图</span> > <a href="javascript:void(0)">选择坐标</a>
            </div>
            <div class="t-right">
            </div>
        </div>
        <div class="com-box">
            <div class="border-info clearfix">
                地址搜索：<input type="text" id="txtAddr" class="text-input-bj  least" />
                <input type="button" value="搜索" onclick="SearchAddr()" class="reg-sub" />
                当前城市：<input type="text" id="txtCurrentCity" class="text-input-bj  least" disabled="disabled" />
                <input type="button" value="修改" onclick="changeCity()" class="reg-sub" />
            ...
            overflow-y: auto; display: none; position: absolute; z-index: 999; background-color: White"
                ...
                <input type="button" value="设置标记" onclick="mark_click()" class="regm-sub" />
            </div>
            <div id="allmap" style="width: 650px; height: 400px; float: left">
            </div>
        </div>
<script type="text/javascript">
