				...
				jQuery.ajax({
					...
					success:function(data){
						...
						for(var i=0;i<data.length;i++){
							...
							html = '<li class="fl mr10">'; 
							html+= '<p class="mt10">';
							html+= "<a href='javascript:;' onclick='delImgById(this,\""+data[i]['path']+"\",\""+oid+"\")' class='sellerBtn02'><span>删除图片</span></a>";
							html+= '</p>';
							html+= '<p class="mt10">';
							html+= "<a class='imga' href='"+data[i]['realpath']+"' onclick='return _showBigPic(this)' >";
							html+= '<img src="'+data[i]['realpath']+'" width="85" height="85"/>';
							html+= '</a>';
							html+= "</p>";
							html+= "</li>";
