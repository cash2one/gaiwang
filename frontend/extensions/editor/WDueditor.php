...
class WDueditor extends CInputWidget
{
     ...
     * @var string
     */
    public $imageDeleteUrl = '/ueditor/fileDelete';
...
//        $assets = Yii::app()->getAssetManager()->publish($baseDir.DIRECTORY_SEPARATOR.'ueditor1_2_5');
        ...
        if ($this->toolbars) {
            ...
            $this->editorOptions['toolbars'][] = array(
                ...
                'insertimage', 'insertframe', 'pagebreak', 'template', '|',
       ...
       setTimeout(function(){
        ...
        editor_{$id}.addListener('beforeInsertImage', function(t, arg) {
            ...
            $("#{$id}").val(imgSrc2);
                ...
                var imgHtml = "<script>function uploadifyRemove{$id}(fileId,attrName){ "+
                "$(\"#imgUploadList{$id} #\"+attrName+fileId).remove();"+
                ...
                for(var i=0; i<imgSrc.length; i++){
                    ...
                    " name=\"imgList[]\" > <a href='javascript:uploadifyRemove{$id}("+i+",\"img_\")'>X</a></li>"
                }
                imgHtml += "<br />";
