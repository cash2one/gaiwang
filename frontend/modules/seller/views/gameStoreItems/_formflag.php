...
<!--                --><?php //echo $model->isNewRecord ? $form->textField($model, 'item_name', array('class' => 'inputtxt1', 'style' => 'width:300px')) : $form->textField($model, 'item_name', array('class' => 'inputtxt1', 'style' => 'width:300px', 'readonly' => true)); ?>
                <?php echo $model->isNewRecord ? $form->dropDownList($model, 'item_name', GameStoreItems::special($items)) : $model->item_name;?>
        ...
        <tr>
            ...
            <td>
                <?php echo $form->textField($model, 'probability', array('class' => 'inputtxt1', 'style' => 'width:300px')); ?>(可设置0-1000000，1为百万分之一概率)
