...
<div class="main clearfix">
    <div class="workground">
        ...
        ?>
        <a href="/gameStoreItems/create" class="mt15 btnSellerEditor2"><?php echo Yii::t('gameStoreItems', '添加商品') ?></a>
        <?php if($store['franchise_stores'] == GameStore::FRANCHISE_STORES_IS):?>
        <a href="/gameStoreItems/createflag" class="mt15 btnSellerEditor2"><?php echo Yii::t('gameStoreItems', '添加特殊商品') ?></a>
        <a href="/gameStoreItems/bird" class="mt15 btnSellerEditor2"><?php echo Yii::t('gameStoreItems', '弹弓打鸟') ?></a>
        <?php endif ?>
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" class="mt10 sellerT3">
            ...
            <?php foreach ($items as $v): ?>
                <tr class="even">
                    ...
                    <td class="ta_c">
                        <?php echo CHtml::link('<span>' . Yii::t('gameStoreItems', '编辑') . '</span>', $this->createAbsoluteUrl($v['flag'] == GameStoreItems::FLAG_ITEMS_YES ? '/seller/gameStoreItems/updateFlag' : '/seller/gameStoreItems/update', array('id' => $v->id)), array('class' => 'sellerBtn03')) ?>
                        &nbsp;&nbsp;
                </tr>
            <?php endforeach; ?>
            </tbody>
