...
<div class="toolbar" style="width: 100%">
	历史累计共 <span style="color: red;font-size:20px;font-weight:bold"><?php echo $count;?></span>个月，
	总销售额 <span style="color: red;font-size:20px;font-weight:bold"><?php echo $allAcount;?></span> 元
</div>
<table width="100%" cellspacing="0" cellpadding="0" border="0" class="mt10 sellerT3">
						<tbody><tr>
								<th class="bgBlack" width="15%"><?php echo Yii::t('middleAgent','月份');?></th>
								<th class="bgBlack" width="5%"><?php echo Yii::t('middleAgent','订单数');?></th>
							...
							<tr class="even">
								<td class="ta_c a_left"><?php echo substr($v->months,0,4).'年'.substr($v->months,-2,2).'月';?> 
								...
								<td class="ta_c"><a href="<?php echo Yii::app()->createUrl("seller/middleAgent/accountDay", array('id'=>$this->getParam('id'),'m' => $v->months))?>">日销售额详情</a></td>
							</tr>
						   <?php endforeach;?>
</tbody></table>
