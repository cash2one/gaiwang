<?php
$title = Yii::t('storeAddress', '添加合作伙伴');
$this->pageTitle = $title.'-'.$this->pageTitle;
$this->breadcrumbs = array(
    Yii::t('storeAddress', '合作伙伴列表 '),
    $title,
);
...
<div class="toolbar">
    <h3><?php echo Yii::t('storeAddress','添加合作伙伴'); ?></h3>
</div>
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" class="mt15 sellerT3">
    ...
    <tr>
        <th><?php echo $form->labelEx($model, '设置合作伙伴'); ?></th>
        <td>
