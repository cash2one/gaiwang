...
<div class="seachToolbar">
    ...
    <table width="60%" border="0" cellspacing="0" cellpadding="0" class="sellerT5">
        <tr >
            <th width="15%" ><p style="width:115px;text-align:center;" ><?php echo Yii::t('GameStoreItems', '手机号：')?></p></th>
            <td width="30%"><input class="inputtxt1" style="width:260px;" name="contact" id="GameStoreItems_item_name" value="<?php echo $contact;?>" maxlength="20" type="text"></td>
