...
<div class="arbox">
    ...
    <h1 class="h1title"> <?php echo Yii::t('sellerDesign','标题'); ?></h1>
    <table>
        <tbody>
        <tr>
            <td style="width: 100px"> <?php echo Yii::t('sellerDesign','标题'); ?></td>
            <td>
                <?php $title = isset($design->tmpData[DesignFormat::TMP_LEFT_CONTACT]['CustomerTitle']) ? $design->tmpData[DesignFormat::TMP_LEFT_CONTACT]['CustomerTitle'] : Yii::t('sellerDesign','在线咨询')?>
                <input class="text-input-bj small" type="text" value="<?php echo $title ?>" name="title" >
            </td>
        </tr>
        </tbody>
    </table>
    ...
    <h1 class="h1title"> <?php echo Yii::t('sellerDesign','在线咨询'); ?></h1>

    <div class="c10"></div>
    <p>
        <input class="button_gray" type="button" onclick="addContactRow()" value="<?php echo Yii::t('sellerDesign','添加'); ?>">
        <?php echo CHtml::link(Yii::t('sellerDesign','开通QQ商家沟通组件'),'http://shang.qq.com',array('target'=>'_blank')); ?>
    </p>
    ...
    <div class="con" style="height: 110px">
        <table class="table_ar" width="100%" cellspacing="0" cellpadding="0" border="0">
            <thead>
            <tr>
                <th style="width: 200px"> <?php echo Yii::t('sellerDesign','咨询名称'); ?></th>
            ...
            <tr id="Contact_<?php echo $k ?>">
                ...
                <td>
                    <input type="text" class="text-input-bj small" value="<?php echo $v['ContactPrefix'] ?>" name="Prefix[]">
                </td>
                <td>
                    <input type="text" class="text-input-bj small" value="<?php echo $v['ContactNum'] ?>" name="ContactNum[]">
                </td>
                <td>
                    <input type="button" class="button_grays" onclick="doDeleteRow('Contact_',<?php echo $k ?>)" value="<?php echo Yii::t('sellerDesign','删除'); ?>">
                </td>
            </tr>
                <?php endforeach; ?>
            <?php endif; ?>
