...
<div class="arbox">
    ...
    <div class="con">
        <table class="table_ar" width="100%" cellspacing="0" cellpadding="0" border="0">
            ...
            <tbody id="dataBody">
            <?php if (isset($design->tmpData[DesignFormat::TMP_MAIN_AD]['Imgs'])): ?>
                <?php foreach ($design->tmpData[DesignFormat::TMP_MAIN_AD]['Imgs'] as $k=>$v): ?>
                    <?php $uid = 'row_' . $k ?>
                    <tr id="<?php echo $uid ?>">
                        <td>
                            <?php
    ...
    <div class="msg msg-info" style="width: <?php echo Yii::t('sellerDesign','320px')?>; float: left"> <?php echo Yii::t('sellerDesign','图片不能超过3张，请上传 "390x154" 大小的图片。'); ?>
