...
<div id="template1" class="mainbj">
    ...
    <div class="shop_entity_box">
        ...
        <div class="editor" id="synopsis">
            <div class="title">
                <img src="<?php echo $this->module->assetsUrl ?>/images/bg/shop_t1.gif" alt=""/>
            </div>
            <div class="cons">
                <p>
                    ...
                    <?php else: ?>
                        <?php echo Yii::t('sellerDesign','暂无介绍'); ?>
                    <?php endif; ?>
                </p>
            </div>
        </div>
        ...
        <div class="editor" id="t1-feature">
            <div class="title"><img src="<?php echo $this->module->assetsUrl ?>/images/bg/shop_t2.gif" width="910"/>
            </div>
            <?php if ($slides): ?>
                <div class="zhans">
        ...
        <div class="editor" id="storeContact">
            <div class="title"><img src="<?php echo $this->module->assetsUrl ?>/images/bg/shop_t3.gif" alt=""/></div>
            <div class="dz_con">
                <span class="as">
                    <?php echo Yii::t('sellerDesign','地址'); ?>：
                    <strong>
                ...
                <span class="as">
                     <?php echo Yii::t('sellerDesign','邮编'); ?>：<strong><?php echo $zipCode ?></strong>
                </span>

                <div class="gzf_bj clearfix">
                    <ul>
                        <li><span class="k1"><?php echo Yii::t('sellerDesign','QQ方式联系我们'); ?></span>
                            <dl>
                                <?php if(!empty($design->tmpData[DesignFormat::TMP_LEFT_CONTACT]['CustomerData'])): ?>
                                <?php foreach ($design->tmpData[DesignFormat::TMP_LEFT_CONTACT]['CustomerData'] as $k => $v): ?>
                                    <dd>
                                        ...
                                        <a href="http://wpa.qq.com/msgrd?v=3&amp;uin=<?php echo $v['ContactNum'] ?>&amp;site=qq&amp;menu=yes"
                                           class="qqon">
                                            <?php echo CHtml::image('http://wpa.qq.com/pa?p=2:' . $v['ContactNum'] . ':41', Yii::t('sellerDesign','点击这里给我发消息')) ?>
                                        </a>
                                    </dd>
                                <?php endforeach; ?>
                                <?php endif; ?>
                        ...
                        <li><span class="k2"><?php echo Yii::t('sellerDesign','邮箱方式联系我们'); ?></span>
                            <dl>
                        ...
                        <li><span class="k3"><?php echo Yii::t('sellerDesign','电话方式联系我们'); ?></span>
                            <dl>
        ...
        <div class="editor" id="storeMap">
            <div class="title"><img src="<?php echo $this->module->assetsUrl ?>/images/bg/shop_t4.gif"/></div>
            <div class="map">
