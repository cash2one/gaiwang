...
<script type="text/javascript">
	...
	window.onload = function() {
		var settings = {
			...
			upload_url: "<?php echo Yii::app()->createUrl('/seller/franchiseeUpload/upload',array('folder_name'=>$folder_name));?>",	// Relative to the SWF file
			...
			file_types_description : "<?php echo Yii::t('sellerFranchiseeUpload', '图像');?>",
			file_upload_limit : 100,
			file_post_name : '<?php echo FranchiseeUploadController::FILE_UPLOAD_NAME?>',
			file_queue_limit : 10,
			custom_settings : {
	...
	<div class="fieldset flash" id="fsUploadProgress"><span class="legend"><?php echo Yii::t('sellerFranchiseeUpload', '快速上传');?></span></div>
		<div id="divStatus"><?php echo Yii::t('sellerFranchiseeUpload', '0 个文件已上传');?></div>
	<div>
		...
		<input id="btnCancel" type="button" value="<?php echo Yii::t('sellerFranchiseeUpload', '取消所有上传');?>" onclick="swfu.cancelQueue();" disabled="disabled" style="margin-left: 2px; font-size: 8pt; height: 29px;" />
	</div>
