...
$this->breadcrumbs = array(
    ...
    Yii::t('sellerFranchisee', '盖网售货机商品库存流水')
);
?>
<div class="toolbar">
	<b> <?php echo $model->name;?> <?php echo Yii::t('sellerFranchisee','的盖网售货机商品库存流水');?></b>
	<span><?php echo Yii::t('sellerFranchisee','盖网售货机商品库存流水。');?></span>
...
<?php if ($no_search!=true ):?>
            ...
            <td width="60%"><input type="submit" class="sellerBtn06" value="<?php echo Yii::t('sellerFranchisee', '搜索');?>"/>&nbsp;&nbsp;
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" class="mt10 sellerT3">
						<tbody><tr>
								<th class="bgBlack" width="20%"><?php echo Yii::t('sellerFranchisee','日期');?></th>
								<th class="bgBlack" width="20%"><?php echo Yii::t('sellerFranchisee','商品名称');?></th>
								<th class="bgBlack" width="10%"><?php echo Yii::t('sellerFranchisee','节点');?></th>
								<th class="bgBlack" width="10%"><?php echo Yii::t('sellerFranchisee','节点类型');?></th>
								<th class="bgBlack" width="10%"><?php echo Yii::t('sellerFranchisee','数量');?></th>
								<th class="bgBlack" width="10%"><?php echo Yii::t('sellerFranchisee','结余');?></th>
							</tr>
