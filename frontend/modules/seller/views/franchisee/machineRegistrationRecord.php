...
$this->breadcrumbs = array(
		...
		Yii::t('sellerFranchisee', '盖网机注册记录'),
);

?>

<div class="toolbar">
	<b><?php echo Yii::t('sellerFranchisee', '盖网机注册记录');?></b>
	<span><?php echo Yii::t('sellerFranchisee', '盖网机注册记录');?>。</span>
</div>
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" class="mt10 sellerT3">
	<tbody>
		<tr>
			...
			<th class="bgBlack" width="10%"><?php echo Yii::t('sellerFranchisee', '注册时间');?></th>
		</tr>
		...
		<tr class="even">
			...
			<td class="ta_c"><?php echo $data->member_id;?></td>
			<td class="ta_c"><?php echo date(Yii::t('sellerFranchisee','Y-m-d G:i:s'),$data->register_time);?></td>
		</tr>
