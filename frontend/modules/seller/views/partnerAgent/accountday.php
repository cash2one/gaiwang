...
$this->breadcrumbs = array(
    Yii::t('partnerAgent', '月销售额列表')=>array('/seller/partnerAgent/mouthAccount'),
    Yii::t('partnerAgent', '日销售额记录')
);
$m=$this->getParam('m');
$id=$this->getParam('id');
?>
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" class="mt10 sellerT3">
						<tbody><tr>
								<th class="bgBlack" width="10%"><?php echo Yii::t('partnerAgent','日期');?></th>
								<th class="bgBlack" width="10%"><?php echo Yii::t('partnerAgent','订单数');?></th>
