...
$this->breadcrumbs = array(
    ...
    $title,
    Yii::t('freightType', '修改指定地区运费设置'),
);
?>
<div class="toolbar">
    <h3><?php echo $typeModel->freightTemplate->name ?> - <?php echo $typeModel::mode($typeModel->mode) ?>
        - <?php echo Yii::t('freightType', '修改指定地区运费设置') ?></h3>
</div>
<?php $this->renderPartial('_form',array('model'=>$model,'typeModel'=>$typeModel,'areaArray'=>$areaArray)) ?>