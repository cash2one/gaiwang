...
?>
    ...
    ?>
        <table width="100%" cellspacing="0" cellpadding="0" border="0" class="mt10 sellerT3">
            <tbody>
                <tr>
                    <th width="10%"><?php echo Yii::t('sellerOrder', '物流公司'); ?></th>
                    <td width="40%">
                ...
                <tr>
                    <th width="10%"><?php echo Yii::t('sellerOrder', '快递单号'); ?></th>
                    <td width="40%">
                ...
                <tr>
                    ...
                    <td> <?php echo CHtml::submitButton(Yii::t('sellerOrder', ($this->action->id == 'changeExpress')?'修改':'发货'), array('class' => 'sellerBtn06')); ?></td>
                </tr>
            </tbody>
        </table>
        <?php $this->endWidget(); ?>
