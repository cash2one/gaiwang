...
<div class="mbRight">
    <div class="EntInfoTab">
        <ul class="clearfix">
            <li class="curr"><a href="javascript:;"><span><?php echo Yii::t('enterpriseLog', '网络店铺签约'); ?></span></a></li>
        </ul>
    </div>
    <div class="mbRcontent sellerWebSign sellerWebSignIcon">
        <div class="toolbarSign">
            ...
            <div>
                若有疑问，请联系商城招商经理：（固话）020-29106888-8363。
                <?php if ($enterprise->service_id): ?>
                    您的招商人员服务编号：<?php echo $enterprise->service_id ?>
                <?php endif; ?>
            </div>
