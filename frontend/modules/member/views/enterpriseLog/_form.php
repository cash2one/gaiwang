...
$uploadTips = Yii::t('memberEnterpriseLog', '(请确保图片清晰)');
        ...
        <tr>
            ...
            <td height="25" colspan="2" class="dtFff pdleft20 hobbies" style="line-height: 30px;">
                <?php if ($enterpriseData->isNewRecord) { ?>
                    <ul class="clearfix">
                        <li class="current"><?php echo Yii::t('enterpriseLog', '企业') ?></li>
                        <li class="">
                            <?php echo CHtml::link(Yii::t('enterpriseLog', '个体工商户'), array('enterpriseLog/enterprise2'), array('onclick' => 'return confirm("请注意！更改网店商户类型后，原有的资料将会清空")'));
                            ?>
                        </li>
                    </ul>
                <?php } elseif ($lastOne->status == EnterpriseLog::STATUS_NOT_PASS  && $lastOne->progress != EnterpriseLog::PROCESS_CLOSE_STORE) { ?>
                    <ul class="clearfix">
                        <li class="current"><?php echo Yii::t('enterpriseLog', '企业') ?></li>
                        <li class="">
                            <?php echo CHtml::link(Yii::t('enterpriseLog', '个体工商户'), array('enterpriseLog/enterprise2'), array('onclick' => 'return confirm("请注意！更改网店商户类型后，原有的资料将会清空")'));
...
<?php echo $form->error($enterprise, 'link_man') ?>
        ...
        <tr id="enterprisePlace">
            <td width="140" height="25" align="center" class="dtEe">
<?php echo Yii::t('memberEnterpriseLog', '公司注册地'); ?>
                <span class="required">*</span>：
            </td>
...
<?php echo $form->error($enterprise, 'street') ?>
        ...
        <tr>
            <td height="50" colspan="3" align="center" class="dtffe">
                <b><?php echo Yii::t('memberEnterpriseLog', '营业执照信息'); ?></b>
            </td>
        </tr>
        <tr id="license">
            <td width="140" height="25" align="center" class="dtEe">
...
<?php $this->renderPartial('_uploadImg', array('model' => $enterpriseData, 'field' => 'organization_image', 'form' => $form)); ?>
        <tr>
            <td height="50" colspan="3" align="center" class="dtffe">
...
<?php echo $form->error($bankAccount, 'account_name') ?>
        ...
        <tr id="account">
            <td width="140" height="25" align="center" class="dtEe">
                <?php echo $form->labelEx($bankAccount, 'account') ?>：
            </td>
            <td height="25" colspan="2" class="dtFff pdleft20">
...
<?php $this->renderPartial('_uploadImg', array('model' => $bankAccount, 'field' => 'licence_image', 'form' => $form)); ?>
        <tr>
            <td height="50" colspan="3" align="center" class="dtffe">
...
<table>
    <tr>
        <td >
<?php echo CHtml::submitButton(Yii::t('memberEnterpriseLog', '保存资料'), array('class' => 'bankBtn', 'style' => 'cursor:pointer;margin:10px 0 0 400px', 'id' => 'formSubmit')) ?>
        </td>
    </tr>
</table>
