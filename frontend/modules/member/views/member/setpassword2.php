            ...
            <div class="mbDate1_c">
                <div class="mgtop20 upladBox integaralbd pdbottom10">
                    ...
                    <span class="fl mgleft14">
                            <h3 class="mgtop10"><?php echo Yii::t('memberMember','二级密码（积分管理密码）'); ?></h3>
                            <p class="gay95 "><?php echo Yii::t('memberMember','权限:积分管理'); ?></p>
                    </span>
                </div>
                <div class="upladBox">
                    <div class="passBox">
                        ...
                        <dl class="clearfix">
                            ...
                            <dd>
                                <?php echo $form->passwordField($model,'password2',array('class'=>'inputtxt','value'=>'')) ?>
