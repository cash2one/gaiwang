            ...
            <div class="mbDate1_c">
                <div class="mgtop20 upladBox integaralbd pdbottom10">
                    ...
                    <span class="fl mgleft14">
                            <h3 class="mgtop10"><?php echo Yii::t('memberMember','三级密码（积分支付）'); ?></h3>
                            <p class="gay95 "><?php echo Yii::t('memberMember','权限:购买商品，积分消费'); ?></p>
                    </span>
                </div>
                <div class="upladBox">
                    <div class="passBox">
                        ...
                        <dl class="clearfix">
                            ...
                            <dd>
                                <?php echo $form->passwordField($model,'password3',array('class'=>'inputtxt','value'=>'')) ?>
                    ...
                    <div class="passPic">
                        ...
                        <div class="passPic_t">
                            ...
                            <span class="fl"><b class="txt"><?php echo Yii::t('memberMember','修改密码成功'); ?></b>
