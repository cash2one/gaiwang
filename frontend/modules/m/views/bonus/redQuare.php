...
<html>
    <head>
       ...
       <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <link type="text/css" rel="stylesheet" href="<?php echo CSS_DOMAIN; ?>m/global.css"/>
		<link type="text/css" rel="stylesheet" href="<?php echo CSS_DOMAIN; ?>m/comm.css"/>
		<link type="text/css" rel="stylesheet" href="<?php echo CSS_DOMAIN; ?>m/module.css"/>
		<link type="text/css" rel="stylesheet" href="<?php echo CSS_DOMAIN; ?>m/redBag.css"/>
		...
		<div class="wrap" id="wrap">
			<div class="header" id="js-header">
				<div class="mainNav">
					<div class="topNav clearfix">
						...
						<!-- <a class="logo TxtTitle fl" href="javascript:void(0);"><img src="<?php echo DOMAIN; ?>/images/m/bg/logo.gif" alt="盖象商城"/></a> -->
			...
			<div class="main">
				<div class="container">			
					...
					<div class="redBagCon mgtop30">
						<div class="column">							
							<div class="columnContent">
								<ul class="mallClass02 clearfix">
                                    <?php
                                    if($category){
                                        foreach($category as $key => $value){
                                    ?>
									<li><a class="item" href="<?php echo $this->createAbsoluteUrl('RedEnvelopeActivity/RedQuareDetail',array('cid' => $key));?>"><img src="<?php echo DOMAIN; ?>/images/m/temp/caretoryImg04.jpg" alt="<?php echo $value;?>"/></a></li>
								    <?php
                                        }
                                    }
                                    ?>
						...
						<div class="coupons mgtop10">
							<!-- 备注：以下<li>中注释内容为不考虑整张优惠券为图片时所用 -->
							<div class="couponTit clearfix"><span class="yelline"></span><p class="titCon"><span class="yellow bigTit">精彩</span>推荐</p></div>
