            ...
            <div class="mbDate1_c">
               <form  id="fromSubmit" method="post" action=<?php echo Yii::app()->createAbsoluteUrl('/m/orderConfirm/agreementPay');?> >
                ...
                <div class="mgtop20 upladBox error">
                    ...
                    <input type="hidden"  name="payAgr" value="<?php echo $model->pay_agreement_id;?>">
                    <input type="hidden"  name="payBusi" value="<?php echo $model->busi_agreement_id;?>">
                    <input type="hidden"  name="tradeNo" value="<?php echo $this->getParam('trade'); ?>">
...
<script type="text/javascript">
    $(function () {
        sendQuickPay("#sendMobileCode",{
    	    payAgr: "<?php echo $model->pay_agreement_id;?>",
    	    payBusi: "<?php echo $model->busi_agreement_id;?>",
    	    moblie: "<?php echo $model->mobile;?>",
    	    tradeNo:"<?php echo $this->getParam('trade');?>",
    	    flag:"1",
