...
<script type="text/javascript">
	...
	window.onload = function() {
		var settings = {
			...
			upload_url: "<?php echo $this->createUrl('fileManage/upload');?>",	// Relative to the SWF file
			post_params: {"PHPSESSID" : "<?php echo session_id(); ?>","HEIGHT":<?php echo $model->height?>,"WIDTH":<?php echo $model->width?>,"YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"},
			file_size_limit : "2 MB",
			file_types : "*.jpg;*.gif;*.png;*.swf",
			file_types_description : "图像",
			file_upload_limit : 100,
			file_post_name : '<?php echo FileManageAgent::FILE_UPLOAD_NAME?>',
			file_queue_limit : 10,
			custom_settings : {
			...
			// Button settings
			button_image_url: "<?php echo $baseUrl;?>/js/swf/images/btn1.gif",	//Relative to the Flash file
			button_width: "125",
			button_height: "25",
     ...
     function uploadStart(obj){
		swfu.addPostParam("YII_CSRF_TOKEN","<?php echo Yii::app()->request->csrfToken;?>");
		return true;
     }
</script>
	...
	<div>
		...
		<input id="btnUpload" type="button" value="" onclick="swfu.startUpload();" disabled="disabled" style="margin-left: 2px; width:121px; height: 25px; background:url(<?php echo $baseUrl;?>/js/swf/images/btn2.gif) no-repeat; border:0;" />
