...
<div class="line container_fluid">
    <div class="row_fluid line">
        <div class="vip_title red">
            <p class="unit fl"><?php echo $model->isNewRecord ? Yii::t('Franchisee', '申请添加加盟商') : Yii::t('Franchisee', '编辑加盟商') ?></p>
        </div>
        <div class="line table_white">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table5">
                ...
                <tr>
                    ...
                    <td width="88%" align="left" class="table_form_right"><?php echo $model->isNewRecord ? Yii::t('Franchisee','编辑中') : Auditing::getStatus($model->status) ?></td>
                </tr>
                <tr>
                    <td align="right"><?php echo Yii::t('Franchisee', '审核意见') ?>：</td>
                    <td align="left" class="table_form_right"><?php echo $model->audit_opinion ?></td>
                </tr>
                <tr class="table1_title" bgcolor="#fcfcfc">
                ...
                <tr>
                    ...
                    <td align="left" class="table_form_right">
                        <?php echo $form->textField($model, 'max_machine', array('class' => 'input_box')); ?><span class="fl" style="color: Red">*</span>
