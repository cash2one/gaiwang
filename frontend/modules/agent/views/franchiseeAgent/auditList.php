    ...
    <div class="line table_white" style="margin: 10px">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
            <tr class="table1_title">
                <td colspan="8"><?php echo Yii::t('Franchisee','审核列表')?>(<?php echo $model->searchAudit()->totalItemCount?>)</td>
            </tr>
            <tr>
				                ...
				                array(  //操作
				                    ...
				                    'buttons'=>array(
				                        'cancel' => array(
				                            ...
				                            'url' => 'Yii::app()->controller->createUrl("confirmBase", array("id"=>$data->primaryKey))',
				                            'imageUrl' => false
				                        ),
				                    ),
				                ),
