...
<br/>
<?php if(!empty($storeModel) && is_array($storeModel)):?>
...
<?php endif;?>
<br/>
<?php if(!empty($storeModel) && $extendModel->apply_type == OfflineSignStoreExtend::APPLY_TYPE_NEW_FRANCHIESE):?>
<div class="sign-tableTitle">添加加盟商<?php echo "<a href='/offlineSignStore/update?storeExtendId=" . $extendModel->id ."' onclick='return deleteChoose(this)'>删除</a>";?></div>
<?php endif;?>
<?php if(!empty($storeModel) && $extendModel->apply_type == OfflineSignStoreExtend::APPLY_TYPE_OLD_FRANCHIESE):?>
    <div class="sign-tableTitle">添加加盟商<?php echo "<a href='/offlineSignStore/OldFranchiseeUNLL/?id=" . $extendModel->id ."' onclick='return deleteChoose(this)'>删除</a>";?></div>
<?php endif;?>
<?php if(empty($storeModel)):?>
    <div class="sign-tableTitle">添加加盟商<?php echo "<a href='/offlineSignStore/update?storeExtendId=" . $extendModel->id ."' onclick='return deleteChoose(this)'></a>";?></div>
<?php endif;?>
<style>
	/*表单错误提示调整*/
	span{
	...
	'clientOptions' => array(
		...
		<div class="sign-conten">
			...
			<div class="sign-list">
				<ul>
					<li>
                        ...
                        <input class="input ml" value="<?php echo $extendModel['enTerName'] ?>" disabled/>
			...
			<div class="sign-btn">
                ...
                <?php endif;?>
				<input type="submit" value="+添加加盟商" class="btn-sign" id="addFranchisee">
				<input type="submit" value="提交资料"  class="btn-sign ml10" id="nextStep">
			</div>
		</div>
