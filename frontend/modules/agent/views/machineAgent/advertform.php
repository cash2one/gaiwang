...
<script src="<?php echo AGENT_DOMAIN.'/agent'; ?>/js/uploadImg.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo AGENT_DOMAIN.'/agent'; ?>/js/zTree/css/zTreeStyle.css" /> 
<script type="text/javascript" src="<?php echo AGENT_DOMAIN.'/agent'; ?>/js/zTree/jquery.ztree.core-3.5.js" ></script> 
<script type="text/javascript" src="<?php echo AGENT_DOMAIN.'/agent'; ?>/js/zTree/jquery.ztree.excheck-3.5.js" ></script>
<link rel="stylesheet" type="text/css" href="<?php echo AGENT_DOMAIN.'/agent'; ?>/js/fancybox/jquery.fancybox-1.3.4.css" /> 
<script type="text/javascript" src="<?php echo AGENT_DOMAIN.'/agent';?>/js/fancybox/jquery.fancybox-1.3.4.pack.js"></script>
...
<div class="ctx">
			...
			<?php 
				switch ($adtype){
					...
					case MachineAdvertAgent::ADVERT_TYPE_SIGN:
						$title = Yii::t('Machine','首页轮播广告');
						break;
					case MachineAdvertAgent::ADVERT_TYPE_VEDIO:
						$title = Yii::t('Machine','视频广告');
						break;
				}
    ...
    <div class="ctxTable">
        ...
        <?php 
			...
			$('#machine-advert-agent-form').submit(function(){
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="0" class="inputTable">
            ...
            <tr>
                ...
                <td>
					...
					<?php echo CHtml::link(Yii::t('Machine','选择分类'),'javascript:showMenu()',array('class'=>'button_04'))?><span class="required">*</span>
            ...
            <?php if ($adtype==  MachineAdvertAgent::ADVERT_TYPE_VEDIO){//视频?>
            <tr>
            	<td class="c1"><?php echo $form->label($model,'vedioname')?></td>
            	<td>
            		<?php echo $form->hiddenField($model,'file_id');?>
            		<?php echo $form->textField($model,'vedioname',array('class'=>'inputbox width200'));?><span class="required">*</span>
            		<?php echo $form->error($model,'vedioname');?>
            	</td>
            </tr>
            <?php }?>
            ...
            <tr>
                ...
                <td>
                	<?php
                        if(!empty($model->svc_start_time)) $model->svc_start_time = date('Y-m-d H:i:s',strtotime($model->svc_start_time));
                        ...
                        ?>
			<?php echo $form->error($model,'svc_start_time'); ?>
                </td>
            </tr>
            <tr>
                ...
                <td>
                	 <?php
                        if(!empty($model->svc_end_time)) $model->svc_end_time = date('Y-m-d H:i:s',strtotime($model->svc_end_time));
                        $this->widget('comext.timepicker.timepicker', array(
                            'cssClass' => 'inputbox width200 datefield',
                            'model' => $model,
                        ...
                        ?>
			<?php echo $form->error($model,'svc_end_time'); ?>
                </td>
            </tr>
		    ...
		    <?php if ($adtype==  MachineAdvertAgent::ADVERT_TYPE_SIGN){//首页轮播?>
		    <tr class="caption">
			    <td colspan="2"><?php echo Yii::t('Machine','广告信息')?></td>
		    </tr>
		    <tr id="trSignPage">
                ...
                <td>
                   	<?php $this->widget('application.modules.agent.widgets.GTUploadPic',array(
                        ...
                        ?>
                	<span class="required">*</span><?php echo Yii::t('Machine','请上传1080X141像素的图片')?>         
            ...
            <tr class="trCoupon">
                ...
                <td>
                	<?php $this->widget('application.modules.agent.widgets.GTUploadPic',array(
	                	...
	                	?>
                	<span class="required">*</span>
                	<?php echo Yii::t('Machine','请上传220X220像素的图片')?>         
            ...
            <tr class="trCoupon">
                ...
                <td>
                	<?php $this->widget('application.modules.agent.widgets.GTUploadPic',array(
	                	...
	                	?>
                	<span class="required"></span>
                	<?php echo Yii::t('Machine','请上传1920X960像素的图片')?>
					<?php //echo $form->error($model,'file_id'); ?>
                </td>
            </tr>
            <tr class="caption trCoupon">
			    <td colspan="2"><?php echo Yii::t('Machine','短信发送信息')?></td>
		    </tr>
            <tr class="trCoupon">
                <td class="c1"><?php echo $form->label($model, 'coupon_name')?>：</td>
                <td>
                	<?php echo $form->textField($model, 'coupon_name',array('class'=>'inputbox width200'))?><span class="required"></span>
					<?php echo $form->error($model,'coupon_name'); ?>
                </td>
            </tr>
            <tr>
                <td class="c1"><?php echo Yii::t('Machine','格子铺地址')?> ：
                </td>
                <td>
                    <?php
		            echo $form->dropDownList($model, 'province_id', RegionAgent::getRegionByParentId($this->getSession('agent_region')), array(
            ...
            <tr class="trCoupon">
                <td class="c1"> <?php echo $form->label($model, 'loc_lng')?>：</td>
                <td>
                	<?php 
            ...
            <!-- 
            <tr class="trCoupon">
                <td class="c1"><?php //echo $form->label($model, 'coupon_content')?>：</td>
                <td>
                	<?php //echo $form->textArea($model, 'coupon_content',array('class'=>'inputarea width400','rows'=>'3','cols'=>2))?>
                	<?php //echo $form->error($model,'coupon_content'); ?>
                </td>
            </tr>
             -->
            <tr class="trCoupon">
                ...
                <td>
                	<?php echo $form->textArea($model, 'coupon_message',array('class'=>'inputarea width400','cols'=>2,'rows'=>3))?><span class="required"></span>
            ...
            <tr class="trCoupon">
                ...
                <td>
                	 <?php
                        if(!empty($model->coupon_start_time)) $model->coupon_start_time = date('Y-m-d H:i:s',strtotime($model->coupon_start_time));
                        $this->widget('comext.timepicker.timepicker', array(
                            'cssClass' => 'inputbox width200 datefield',
                            'model' => $model,
            ...
            <tr class="trCoupon">
                ...
                <td>
                	<?php
                        if(!empty($model->coupon_end_time)) $model->coupon_end_time = date('Y-m-d H:i:s',strtotime($model->coupon_end_time));
                        $this->widget('comext.timepicker.timepicker', array(
                            'cssClass' => 'inputbox width200 datefield',
                            'model' => $model,
            ...
            <tr class="trCoupon">
                ...
                <td>
                	<?php echo $form->textField($model, 'coupon_quantity', array('class'=>'inputbox'))?><span class="required"></span>
    ...
    <div class="align-center">
        ...
        <?php echo CHtml::link(Yii::t('Public','返回'),$this->createUrl('machineAgent/advertList',array('id'=>$machine_id,'adtype'=>$adtype)),array('class'=>'button_04'))?>
    </div>
<?php $this->endWidget();?>   
</div>
</div>