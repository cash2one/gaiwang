    ...
    <div class="cn1">
        <a href="javascript:;" class="w60x60 img_m">
            <?php if (!empty($data['head_portrait'])): ?>
                <?php echo CHtml::image(Tool::showImg(ATTR_DOMAIN . '/' . $data['head_portrait'], 'c_fill,h_60,w_60'), Yii::t('goods', '头像'), array('width' => 60, 'height' => 60)); ?>
            <?php else: ?>
                <?php echo CHtml::image(Tool::showImg(ATTR_DOMAIN . '/head_portrait/default.jpg', 'c_fill,h_60,w_60'), Yii::t('goods', '头像'), array('width' => 60, 'height' => 60)); ?>
            <?php endif; ?>
        </a>
