...
.list{ height:auto; }
	...
	<div id=con>
		<!-- 标签名称 -->
		<ul id=tags>
			<li class=selectTag><a onClick="selectTag('tagContent0',this)" href="javascript:void(0)"><?php echo Yii::t('sellerUpload', '图片空间'); ?></a> </li>
		  	<li><a onClick="selectTag('tagContent1',this)" href="javascript:void(0)"><?php echo Yii::t('sellerUpload', '添加图片'); ?></a> </li>
		</ul>
		<!-- 标签内容 -->
		<div id=tagContent>
			...
			<div class="tagContent" id=tagContent1>
				<?php
					$this->renderPartial('application.views.upload.create',
						array(
							'height'=>$height,
							'width'=>$width,
