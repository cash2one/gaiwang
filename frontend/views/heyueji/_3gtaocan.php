<div class="packageList">
    <div class="packageAbout">
        <ul class="clearfix">
            ...
            <li><b>合约期：</b><i class="planDat">24个月</i></li>
            <li><b>套餐类型：</b><i class="planCat">乐享3G上网版</i>套餐资费详情</li>
            <li></li>
        </ul>
    </div>
    <div class="packageDetail">
        <table class="packageCont">
            ...
            <tbody>
                ...
                <?php endforeach; ?>
                <tr>
                    <td colspan="6"><a href="javascript:" title="" class="btnPackage" onclick="showReturn()">确认套餐</a></td>
                </tr>
            </tbody>        
        </table>
    </div>
