                        ...
                        <dl class="filterDl" id="filterDl">
                            ...
                            <?php else: ?>
                                <?php foreach ($brand as $val): ?>
                                    <dd><a href="<?php echo $this->createAbsoluteUrl('/search/view', array_merge($params, array('bid' => $val['id']))); ?>"><?php echo Yii::t('category',$val['name']) ?>(<?php echo $val['code'] ?>)<span class="gray">(<?php echo $val['total'].' '.Yii::t('site', '件') ?>)</span></a></dd>
                                <?php endforeach; ?>
                            <?php endif; ?>
                        ...
                        <dl class="filterDl" id="filterD2">
                            ...
                            <?php else: ?>
                                <?php foreach ($category as $val): ?>
                                    <dd><a href="<?php echo $this->createAbsoluteUrl('/search/view', array_merge($params, array('cid' => $val['id']))); ?>"><?php echo Yii::t('category', $val['name']) ?></a><span class="gray">(<?php echo $val['total'].' '.Yii::t('site', '件') ?>)</span></a></dd>
                                <?php endforeach; ?>
                            <?php endif; ?>
                    ...
                    <?php foreach ($goods as $g): ?>
                        <li>
                            <div class="libox">
                                ...
                                <p><?php // echo Yii::t('search', '销量：{a}件', array('{a}' => $g->sales_volume)); ?></p>


                                <p class="integral"><?php echo Yii::t('contact', '换购积分'); ?>:<span class="jf"><?php echo HtmlHelper::priceConvertIntegral($g['price']); ?></span></p>
                            </div>
                            <!--                            <a href="#" class="add_cart Carfly" title="加入购物车">加入购物车</a>-->
