...
class Sms
{
     ...
     * @return array()
     */
    public static function send($phoneNumber, $content, $datas= null, $tmpId =null, $api = null)
    {        
        $errorReturn = array(
            'create_time' => time(),
            'send_count' => 0,
...
//        //写死 测试队列问题
//        $smsConfig['currentAPI'] =  SmsLog::INTERFACE_RLY;
...
//     		SmsLog::INTERFACE_YX => 1,
    		SmsLog::INTERFACE_JXT => SmsLog::INTERFACE_JXT,
//     		SmsLog::INTERFACE_DXT => 1,
                                    SmsLog::INTERFACE_RLY => SmsLog::INTERFACE_RLY,
    );
    /**
     * 大陆的发短信方法
