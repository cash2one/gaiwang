...
class WDueditor extends CInputWidget {
     ...
     * 网站的域名
     */
    public $base_url = MANAGE_DOMAIN;    //默认是后台域名
...
//        $assets = Yii::app()->getAssetManager()->publish($baseDir.DIRECTORY_SEPARATOR.'ueditor1_2_5');
        ...
        $config = array(
            ...
            //图片配置区
            'imageUrl' => $base_url . '/?r=ueditor/imageUp',
            'imagePath' => $this->url,
            //涂鸦配置区
            'scrawlUrl' => $base_url . '/?r=ueditor/scrawlUp',
            'scrawlPath' => $this->url,
            //图片在线管理配置区
            'imageManagerUrl' => $base_url . '/?r=ueditor/imageManager',
